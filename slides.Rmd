...
5. No tempo restante: (Dica: [Relembre como fazer no tutorial enviado](https://beatriz-milz.shinyapps.io/tutorial_markdown/))
...
5. No tempo restante: (Dica: [Relembre como fazer no tutorial enviado](https://beatriz-milz.shinyapps.io/tutorial_markdown/))
  ...
  - Adicione uma tabela a partir de um `data frame` (pode usar `mtcars`, por exemplo).
  
  - Adicione uma imagem na sua apresentação. (Dica: crie uma pasta `img`, salve a imagem nesta pasta)
